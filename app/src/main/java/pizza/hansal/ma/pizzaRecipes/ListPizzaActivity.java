...
import pizza.hansal.ma.pizzaRecipes.adapter.PizzaAdapter;
import pizza.hansal.ma.pizzaRecipes.beans.Produit;
import pizza.hansal.ma.pizzaRecipes.service.ProduitService;
...
public class ListPizzaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent intent = new Intent(ListPizzaActivity.this, PizzaDetailsActivity.class);
        ...
        intent.putExtra("pizzaIngredients", selectedPizza.getDetailsIngred());
